  ...
  return (
    ...
    >
      <View style={styles.slide}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.subtitle}>
            Revolutionizing ideas through discussions at a single platform.
            Delivered specially for the IITK junta!
          </Text>
        </View>
      </View>
      ...
      <View style={styles.slide}>
        ...
        <View style={styles.footer}>
          <Text style={styles.title}>Topic Specific</Text>
          <Text style={styles.subtitle}>
            Check out streams that fit your genre and interests. Subscribe them
      ...
      <View style={styles.slide}>
        <View style={styles.header}>
          <Image
            source={require("./asset/custom2.png")}
            style={styles.image3}
            resizeMode={"stretch"}
          />
        </View>
        <View style={styles.footer}>
          <Text style={styles.title}>Create Posts</Text>
          <Text style={styles.subtitle}>

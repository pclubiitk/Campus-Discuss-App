...
const LoginComponent = () => {
    ...
    const handleUsername = (e: NativeSyntheticEvent<TextInputChangeEventData>): void => {
        const value = e.nativeEvent.text;
        setUsername(value);
    }

    const handlePassword = (e: NativeSyntheticEvent<TextInputChangeEventData>): void => {
        const value = e.nativeEvent.text;
        setPassword(value);
    }
            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <View style={styles.section}>
                        ...
                        />
                        {password !== "" ?
                            <MaterialIcons name="remove-red-eye" size={20} onPress={() => handleSecureText()} /> : null}
                    </View>
                </View>
                <TouchableOpacity>
